...
def test_deploy():
    ...
    sdk_sdk_utils.out('Checking that tasks are failing to launch for at least {}s'.format(wait_time))
    ...
    def fn():
        ...
        sdk_sdk_utils.out('Task states: {}'.format(states))
    ...
    try:
        ...
        sdk_sdk_utils.out('Timeout reached as expected')
